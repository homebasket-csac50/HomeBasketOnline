<?php 
  ...
  if(isset($_SESSION['email']) && !empty($_SESSION['email'])) {
      ...
      $categoryName = $_POST['category_name_key'];
  ...
  left: 30px;" onclick="openNav()">&#9776; </span>
                ...
                <?php 
                      ...
                      while ($row = $result->fetch_assoc())  {
                        ...
                        $output.= "<form method='POST' action='category.php' onSubmit='myFunction()'>
                          ...
                          <td><b>
                            <input type='button' id='myBtn' style='background-color: #4CAF90;color: white; padding: 5px 10px;margin: 0;border: none;cursor: pointer;width: 80%;overflow:hidden;' value='Edit' onclick=openbox({$row['category_id']},'{$row['category_name']}') >
                            <b></td><td><b>
                            <input type='Submit' name='deleteSubmit' Value='Delete' style='background-color: #4CAF90;color: white; padding: 5px 10px;margin: 0;border: none;cursor: pointer;width: 80%;overflow:hidden;' readonly/>
                          <b></td></tr>
                          </form>";
                        }
                        echo $output;
    ...
    <div id="myModal" class="modal">
        ...
        <div class="modal-content">
            ...
            <form class="modal-content animate" action="category.php" method="POST" novalidate>
            ...
            <div class="modal-body">
                    ...
                    <div class="">
                        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12" id="addCatBlock" style="display:none;">
                            ...
                            <input required type="text" placeholder="Category" name="category_name_key">
                            
                        </div>
                        
                        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12" id="editCatBlock" style="display:none;">
                            <label for="category"><b>Category</b></label>
                            <input required type="text" placeholder="Category" name="category_id" id="catIdMain">
                            <input required type="text" placeholder="Category" name="category_name" id="catNameMain">
            ...
            <input type="submit" value="Add" class="modalButtons" id="addButton" name="insertSubmit" style="display:none; background-color: #4CAF90;" />
                ...
                <input type="submit" value="Edit" class="modalButtons" id="editButton"  name="editCategory" style="display:none; background-color: #4CAF90;"/>
...
<script>
    ...
    function openbox(id, name) {
        ...
        document.getElementById("addCatBlock").style.display = "none";
